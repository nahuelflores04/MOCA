...
import {
  ...
  getUserById,
  getUserByUsername,
} from "../../../databases/sql/sql_querys_main.js";

passport.use(
  new LocalStrategy(async function (legajo, password, done) {
...
router.post(
  ...
  passport.authenticate("local", {
    successRedirect: "http://localhost:5000/auth_pass",
    failureRedirect: "http://localhost:5000/login_error",
  })
);
